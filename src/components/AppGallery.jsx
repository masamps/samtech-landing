 ...
 *
 * Houve uma tentativa de exibir os aparelhos em perspectiva. Foi descartada:
 * o deslocamento em 3D tirava a legenda de baixo do respectivo aparelho e,
 * em telas de 1024px, cortava o primeiro celular na borda. Corrigir os dois
 * problemas exigiria reduzir o efeito a ponto de não valer a pena.
 */
  ...
  return (
    ...
    >
      {screens.map((screen) => (
        ...
        >
          {/* moldura do aparelho */}
          <div className="rounded-[2rem] border border-white/15 bg-[#0b0b11] p-1.5 shadow-card transition-transform duration-300 hover:-translate-y-2">
            <img
              src={screen.src}

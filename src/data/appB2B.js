...
export const appB2B = {
  ...
  features: [
    {
      icon: "LayoutGrid",
      title: "O cliente encontra o produto",
      items: [
        "Catálogo com foto, preço e estoque atualizado",
        "Busca, filtros e navegação por categoria",
        "Banners de promoção na tela inicial",
        "Preço e condição da tabela daquele cliente",
      ],
    },
    {
      icon: "ShoppingCart",
      ...
      items: [
        "Carrinho que não some ao fechar o aplicativo",
        "Revisão com impostos calculados antes de enviar",
        "Escolha de pagamento, transportadora e entrega",
        "Pedido cai direto no seu sistema, sem redigitação",
      ],
    },
    {
      icon: "PackageSearch",
      title: "Acompanha e volta a comprar",
      items: [
        "Histórico de pedidos com situação e valores",
        "Entrada por digital ou Face ID",
        "Cadastro pelo próprio aplicativo",
        "Um app atende várias empresas ou filiais",
      ],
    },
  ],
